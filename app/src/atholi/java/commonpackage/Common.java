...
public class Common {
     ...
     public final static String MOBILE_CODE_SMS="ASCBNK";
    public final static boolean HOSTNAMEVERFICATION_MANUAL=true;
    public final static String HOSTNAME_SUBJECT="node03";
    public final static String CERTIFICATE_ASSET_NAME= "atholi.crt";
    private static String BASE_URL= "https://117.218.68.168:14001";
