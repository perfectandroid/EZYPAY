...
public class Common {
     ...
     public final static String MOBILE_CODE_SMS="CHNRCB";
    public final static boolean HOSTNAMEVERFICATION_MANUAL=true;
    public final static String HOSTNAME_SUBJECT="admin-PC";
    public final static String CERTIFICATE_ASSET_NAME= "cheruvannur.crt";
    private static String BASE_URL= "https://117.218.68.54:14001";
