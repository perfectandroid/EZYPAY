...
public class Common {
     ...
     public final static String MOBILE_CODE_SMS="CITYCB";

    public final static boolean HOSTNAMEVERFICATION_MANUAL=true;
    public final static String HOSTNAME_SUBJECT="mobapp";
    public final static String CERTIFICATE_ASSET_NAME= "calicutcityservice.crt";
    private static String BASE_URL= "https://117.239.157.54:14001";
