...
public class Common {
     ...
     public final static String MOBILE_CODE_SMS="MACHOS";
    public final static boolean HOSTNAMEVERFICATION_MANUAL=true;
    public final static String HOSTNAME_SUBJECT="NETPC";
    public final static String CERTIFICATE_ASSET_NAME= "mannarkkadu_taluk.crt";
    private static String BASE_URL= "https://59.96.23.239:14001";
